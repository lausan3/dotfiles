...
# bun completions
[ -s "/Users/anthony/.bun/_bun" ] && source "/Users/anthony/.bun/_bun"
...
__conda_setup="$('/Users/anthony/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/anthony/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/anthony/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/anthony/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# air
export PATH="$PATH:/Users/anthony/go/pkg/mod/github.com/air-verse/air@v1.61.7/bin"
